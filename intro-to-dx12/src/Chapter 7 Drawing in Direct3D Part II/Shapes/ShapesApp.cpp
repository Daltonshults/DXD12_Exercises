...
{
    std::fstream file("Models/skull.txt");
    ...
    while (std::getline(file, line)) {
        ...
        if (readingTriangles) {
            triangle t;
            if (ss >> t.a >> t.b >> t.c) {
                indices1.push_back(t.a);
                indices1.push_back(t.b);
                indices1.push_back(t.c);
            }
        }
    }
    ...
    skullSubmesh.IndexCount = triangleCount * 3;
